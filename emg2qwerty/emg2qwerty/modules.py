...
class GRUEncoder(nn.Module):
    """GRU encoder for inputs of shape (T, N, num_features).

    Returns:
        Tensor of shape (T, N, hidden_size * num_directions)
    """
    ...
    def __init__(
        ...
        self.output_features = hidden_size * (2 if bidirectional else 1)
...
class TemporalConv1D(nn.Module):
    ...
    def __init__(
        ...
        self.output_features = conv_channels
